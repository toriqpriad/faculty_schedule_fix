...
function advancedFormCtrl($http, $timeout, $interval) {
  var vm = this;
  ...
  vm.clear = function() {
    ...
    vm.bootstrap.selected = undefined;
  ...
  vm.bestPictures = new Bloodhound({
...
angular.module('app').controller('advancedFormCtrl', ['$http', '$timeout', '$interval', advancedFormCtrl]);