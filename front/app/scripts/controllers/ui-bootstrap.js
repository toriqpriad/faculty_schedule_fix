...
function CarouselDemoCtrl($scope) {
  ...
  $scope.addSlide = function() {
    ...
    slides.push({
      image: 'http://placeimg.com/' + newWidth + '/300',
...
angular.module('app').controller('TypeaheadCtrl', ['$scope', '$http', TypeaheadCtrl]).controller('TimepickerDemoCtrl', ['$scope', '$log', TimepickerDemoCtrl]).controller('ModalDemoCtrl', ['$scope', '$uibModal', '$log', ModalDemoCtrl]).controller('ModalInstanceCtrl', ['$scope', '$uibModalInstance', 'items', ModalInstanceCtrl]).controller('RatingDemoCtrl', ['$scope', RatingDemoCtrl]).controller('AccordionDemoCtrl', ['$scope', AccordionDemoCtrl]).controller('PopoverDemoCtrl', ['$scope', PopoverDemoCtrl]).controller('TooltipDemoCtrl', ['$scope', '$sce', TooltipDemoCtrl]).controller('PaginationDemoCtrl', ['$scope', '$log', PaginationDemoCtrl]).controller('AlertDemoCtrl', ['$scope', AlertDemoCtrl]).controller('CarouselDemoCtrl', ['$scope', CarouselDemoCtrl]).controller('ButtonsCtrl', ['$scope', ButtonsCtrl]).controller('CollapseDemoCtrl', ['$scope', CollapseDemoCtrl]).controller('DatepickerDemoCtrl', ['$scope', DatepickerDemoCtrl]);